...
begin
  if isShow then if MyMessagebox(GetLanguage('messagebox_mainform.release_memory_optimize_warning.caption'), GetLanguage('messagebox_mainform.release_memory_optimize_warning.text'), MY_WARNING, [mybutton.myNo, mybutton.myYes]) = 1 then exit;
